        ...
        <div className="w-full max-w-6xl mx-auto py-32 px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-16 gap-y-20">
                ...
                <div>
                    ...
                    <p className="text-foreground-secondary text-regular text-balance leading-relaxed">
                        <a href="https://github.com/Onlook/Onlook-dev" target="_blank" rel="noopener noreferrer" className="underline">Browse our GitHub repo</a> to understand how designAI works, contribute improvements, or customize it for your team's needs.
                    </p>
                </div>
            </div>
        </div>
