                ...
                <div className="flex-1 flex flex-col md:flex-row gap-12 md:gap-24 justify-center">
                    <div>
                        ...
                        <ul className="flex flex-col gap-4 text-regular text-foreground-secondary">
                            ...
                            <li><a href={ExternalRoutes.DOCS} target="_blank" className="hover:underline" title="View designAI documentation">Docs</a></li>
                            <li><a href={Routes.FAQ} className="hover:underline" title="Frequently Asked Questions">FAQ</a></li>
                            <li><a href={ExternalRoutes.BLOG} target="_blank" className="hover:underline" title="Read the designAI blog">Blog</a></li>
                            {/* <li><a href="#" className="hover:underline">Careers</a></li> */}
                            <li><a href="mailto:contact@onlook.com" className="hover:underline" title="Contact designAI support">Contact</a></li>
                        </ul>
                    </div>
                    <div className="min-w-[200px]">
                        ...
                        <ul className="flex flex-col gap-4 text-regular text-foreground-secondary">
                            ...
                            <li><a href={ExternalRoutes.GITHUB} target="_blank" className="hover:underline" title="View designAI on GitHub">GitHub Repo</a></li>
                            <li><a href="/features" className="hover:underline" title="View designAI features">Features</a></li>
                            ...
                            <li><a href="/pricing" className="hover:underline" title="View designAI pricing">Pricing</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-regularPlus mb-4 text-foreground-primary">Follow Us</h3>
                        <div className="flex gap-6 mt-2 items-center">
                            <a href={ExternalRoutes.X} target="_blank" rel="noopener noreferrer" title="Follow designAI on X">
                                <Icons.SocialX className="w-6 h-6 text-foreground-secondary hover:text-foreground-primary transition-colors" />
                            </a>
                            <a href={ExternalRoutes.LINKEDIN} target="_blank" rel="noopener noreferrer" title="Connect with designAI on LinkedIn">
                                <Icons.SocialLinkedIn className="w-6 h-6 text-foreground-secondary hover:text-foreground-primary transition-colors" />
                            </a>
                            <a href={ExternalRoutes.SUBSTACK} target="_blank" rel="noopener noreferrer" title="Subscribe to designAI on Substack">
                                <Icons.SocialSubstack className="w-6 h-6 text-foreground-secondary hover:text-foreground-primary transition-colors" />
                            </a>
                            <a href={ExternalRoutes.YOUTUBE} target="_blank" rel="noopener noreferrer" title="Watch designAI on YouTube">
                                <Icons.SocialYoutube className="w-6 h-6 text-foreground-secondary hover:text-foreground-primary transition-colors" />
                            </a>
                            <a href={ExternalRoutes.GITHUB} target="_blank" rel="noopener noreferrer" title="View designAI on GitHub">
                                <Icons.GitHubLogo className="w-5.5 h-5.5 text-foreground-secondary hover:text-foreground-primary transition-colors" />
                            </a>
                            <a href={ExternalRoutes.DISCORD} target="_blank" rel="noopener noreferrer" title="Join the designAI Discord community">
