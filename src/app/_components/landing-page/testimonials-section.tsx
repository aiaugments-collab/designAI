        ...
        <div className="w-full max-w-6xl mx-auto py-48 px-8">
            ...
            <div className="w-full flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="flex flex-col gap-8 flex-1">
                    ...
                    />
                    <TestimonialCard
                        text="From an era where web designers were synonymous with Photoshop and XD, we've moved into the Figma era. And now, a new tool powered by AI has emerged! Its name is 'designAI'. In summary, it seems you can publish your designs directly."
                        name="Ryutaro"
                        label="Studio Nika"
